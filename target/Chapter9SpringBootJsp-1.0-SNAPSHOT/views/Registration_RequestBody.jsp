...
<div style="margin-top:50px; margin-left:250px; height:50px;"><h2>Employee <c:out
        value="${employee.id != null ? 'Update' : 'Registration' }"/></h2></div>

<form:form method="POST" modelAttribute="employee" action="/addNew" name="employee">
    <table style="vertical-align: center; margin-left:20%;">
        ...
        <tr>
            <td colspan="2">
                ...
                <c:if test="${employee.id ne null}"><b>|</b>&nbsp;
